...
type MortgageProfileRepository interface {
	Create(ctx context.Context, tx *sql.Tx, profile *models.MortgageProfile) error
	FindByID(ctx context.Context, id int) (*models.MortgageProfile, error)
}
...
func (r *mortgageProfileRepository) Create(ctx context.Context, tx *sql.Tx, profile *models.MortgageProfile) error {
...
func (r *mortgageProfileRepository) FindByID(ctx context.Context, id int) (*models.MortgageProfile, error) {
